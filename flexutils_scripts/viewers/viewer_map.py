...
from traits.api import HasTraits, Instance, Array, Float, Bool, String, on_trait_change, List
...
import flexutils_scripts
from flexutils_scripts.utils import computeBasis, getCoordsAtLevel, resizeZernikeCoefficients
from flexutils_scripts import xpdb
...
class MapView(HasTraits):
    ...
    view = View(HSplit(
        ...
        resizable=True,
        title='Map rendering',
        icon=flexutils_scripts.getImagePath("icon_square.png")
    )
