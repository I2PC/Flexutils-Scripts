...
def applyDeformationField(map, mask, output, path, z_clnm, L1, L2, Rmax):
    ...
    file_output = os.path.join(path, output)
    writeZernikeFile(z_file, z_clnm, L1, L2, Rmax)
    apply_deformation_field_zernike3d(mask_file, file_input, z_file, file_output, 2. * Rmax,
